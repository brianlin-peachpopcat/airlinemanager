...
const LIVERY_TEMPLATES = {
  ...
  b717: {
    src: "img/liveries/b717.png",
    srcGnd: "img/liveries/b717-gnd.png",
    win: [0.15, 0.62, 0.60, 0.72],
    winGnd: [0.15, 0.56, 0.60, 0.66],
    belly: [[-0.02, 0.80], [0.70, 0.80], [0.70, 1.02], [-0.02, 1.02]],
    eng: [[0.68, 0.36, 0.86, 0.70]],
    tail: [[0.80, 0.52], [0.86, -0.02], [1.02, -0.02], [1.02, 0.55]],
  },
  b747: {
...
const LIVERY_TPL_MAP = {
  ...
  b737: "b737ng", b738: "b737ng", b738f: "b737ng",
  b717: "b717",
  // 737 MAX
  b38m: "b38m",
